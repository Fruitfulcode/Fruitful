    ...
    class TGM_Plugin_Activation {
        ...
        public function __construct() {
            ...
            $this->strings = array(
                ...
                'notice_can_install_required'    => __( 'This theme requires the following plugin: %1$s.', 'tgmpa' ),
                'notice_can_install_recommended' => __( 'This theme recommends the following plugin: %1$s.', 'tgmpa' ),
                'notice_cannot_install'          => __( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'tgmpa'),
                'notice_can_activate_required'   => __( 'The following required plugin is currently inactive: %1$s.','tgmpa' ),
                'notice_can_activate_recommended'=> __( 'The following recommended plugin is currently inactive: %1$s.', 'tgmpa' ),
                'notice_cannot_activate'         => __( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'tgmpa'),
                'notice_ask_to_update'           => __( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'tgmpa'),
                'notice_cannot_update'           => __( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'tgmpa'),
                'install_link'                   => __( 'Begin installing plugin', 'tgmpa' ),
                'activate_link'                  => __( 'Begin activating plugin', 'tgmpa' ),
