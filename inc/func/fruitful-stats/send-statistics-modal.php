...
class FruitfulStatisticModal
{
	...
	public function __construct()
	{
		...
		add_action( 'wp_ajax_fruitfultheme_dismiss_subscribe_notification', array( $this, 'dismiss_subscribe_notification' ) );
	}
	...
	public function admin_show_modal() {
		...
		if( ! $ffc_statistics_option ) {
			require  dirname( __FILE__ )  . '/view/send-statistics-modal-view.php';
		}
	}
