...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
         ...
         * @var string
         */
        public $menu = 'fruitful-install-plugins';
         ...
         * does the fruitful_init action hook, and hooks in the interactions to init.
         *
         * @since 1.0.0
         *
        ...
        public function __construct() {
            ...
            do_action_ref_array( 'fruitful_init', array( $this ) );
        ...
        public function thickbox() {
            ...
            if ( ! get_user_meta( get_current_user_id(), 'fruitful_dismissed_notice', true ) ) {
                add_thickbox();
            }
        ...
        public function install_plugins_page() {
            ...
            <div class="fruitful wrap">
                ...
                <form id="fruitful-plugins" action="" method="post">
                    <input type="hidden" name="fruitful-page" value="<?php echo $this->menu; ?>" />
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['fruitful-install'] ) && 'install-plugin' == $_GET['fruitful-install'] ) ) {
                check_admin_referer( 'fruitful-install' );
            ...
            elseif ( isset( $_GET['plugin'] ) && ( isset( $_GET['fruitful-activate'] ) && 'activate-plugin' == $_GET['fruitful-activate'] ) ) {
                check_admin_referer( 'fruitful-activate', 'fruitful-activate-nonce' );
        ...
        public function notices() {
            ...
            if ( ! empty( $message ) ) {
                ...
                foreach ( $message as $type => $plugin_groups ) {
                    ...
                    $rendered .= '<p>' . sprintf( translate_nooped_plural( $this->strings[$type], $count, 'fruitful' ), $imploded, $count ) . '</p>';
                }
                ...
                if ( ! empty( $this->strings['nag_type'] ) ) {
                    add_settings_error( 'fruitful', 'fruitful', $rendered, sanitize_html_class( strtolower( $this->strings['nag_type'] ) ) );
                } else {
                    add_settings_error( 'fruitful', 'fruitful', $rendered, $nag_class );
                }
            }

            // Admin options pages already output settings_errors, so this is to avoid duplication.
            if ( 'options-general' !== $current_screen->parent_base ) {
                settings_errors( 'fruitful' );
            }
        ...
        public function dismiss() {
            ...
            if ( isset( $_GET['fruitful-dismiss'] ) ) {
                update_user_meta( get_current_user_id(), 'fruitful_dismissed_notice', 1 );
            }
        ...
        public function update_dismiss() {
            ...
            delete_user_meta( get_current_user_id(), 'fruitful_dismissed_notice' );
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                $table_data[$i]['type'] = isset( $plugin['required'] ) && $plugin['required'] ? __( 'Required', 'fruitful' ) : __( 'Recommended', 'fruitful' );
        ...
        public function no_items() {
            ...
            printf( __( 'No plugins to install or activate. <a href="%1$s" title="Return to the Dashboard">Return to the Dashboard</a>', 'fruitful' ), network_admin_url() );
            echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
        ...
        public function get_bulk_actions() {
            ...
            $actions = array(
                'fruitful-bulk-install'  => __( 'Install', 'fruitful' ),
                'fruitful-bulk-activate' => __( 'Activate', 'fruitful' ),
            );
        ...
        public function process_bulk_actions() {
            ...
            if ( 'fruitful-bulk-install' === $this->current_action() ) {
                ...
                // Loop through each plugin to install and try to grab information from WordPress API, if not create 'fruitful-empty' scalar.
                $i = 0;
                foreach ( $plugin_installs as $plugin ) {
                    $api[$i] = plugins_api( 'plugin_information', array( 'slug' => $plugin, 'fields' => array( 'sections' => false ) ) ) ? plugins_api( 'plugin_information', array( 'slug' => $plugin, 'fields' => array( 'sections' => false ) ) ) : (object) $api[$i] = 'fruitful-empty';
                    $i++;
                }
            ...
            if ( 'fruitful-bulk-activate' === $this->current_action() ) {
                check_admin_referer( 'bulk-' . $this->_args['plural'] );
