		...
		$this->sections['general'] = array(
			...
			'fields'	=> array(
				array(
					...
					'info'          => __( 'Theme supported 2 types of html layout. Default responsive setting which adapt for mobile devices and static page with fixed width. Uncheck arrow below if you need static website display', 'fruitful' ),
				...
				array(
					...
					'info'			=> __( 'If you want to display comments on your post page or page, select options below.','fruitful' ),
					'fields'		=>  array (
						array(
							'id' 			=> 'postcomment',
				...
				array(
					...
					'info'          => __( 'Select option below for show featured image on single post page.', 'fruitful' ),
		...
		$this->sections['background'] = array(
			...
			'fields'	=> array(
				array(
					...
					'info'			=> __( 'Upload your background image for site background. (Supported files .png, .jpg, .gif)', 'fruitful' ),			
					'fields'		=>  array (	
						array(
						'id' 			=> 'backgroung_img',
						'type'			=> 'image',
		...
		$this->sections['fonts'] = array(
			...
			'fields'	=> array(
				...
				array(	
					...
					'info'			=> __( 'Choose font size for specific html elements. Set size as number, without px..', 'fruitful' ),	
					'fields'		=>  array (	
						array(
							'id' 			=> 'h1_size',
							'type'			=> 'text',
		...
		$this->sections['slider'] = array(
			...
			'fields'	=> array(	
				...
				array(
					...
					'info'			=> __( 'Choose needed options for slider: animation type, sliding direction, speed of animations, etc', 'fruitful' ),
					'type'			=> 'slider-options',
					'fields'		=> array (
						array(
							'id'			=> 's_animation',
						...
						array(
							...
							'type'			=> 'text',
							'option-block'	=> 'flex-slider',
							'box-title'		=> __('Set the speed of the slideshow cycling, in milliseconds','fruitful'),
							'default'		=> '7000' 	
						),	
						array(
							'id'			=> 's_animationSpeed',
		...
		$this->sections['social-links'] = array( 
			...
			'fields'	=> array(	
				...
				array(	
					...
					'info'			=> __( 'Add link to your social media profiles. Icons with link will be display in header or footer.', 'fruitful' ),	
					'fields'		=>  array (	
						array(
							'id'		=> 'facebook_url',
							'type'		=> 'text',
	...
	/*Custom CSS*/
		$this->sections['custom-css'] = array(
			...
			'fields'				=> array(	
				...
				'info'		=>  __('Theme has two css files style.css and fixed-style.css which use default styles for front-end responsive and static layout. Do not edit theme default css files, use textarea editor below for overwriting all css styles.','fruitful'),
