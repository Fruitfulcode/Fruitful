...
class Fruitful_Widget_Last_Tweets extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $tweets ): ?>
			<div class="tweets_list">
				<p class="tweets_user_title">
						<a href="<?php echo $tweets[0]['user_link']; ?>">
	...
	<?php endif; 
		  ...
		  wp_enqueue_style( 'wdgt_twits_style', get_template_directory_uri() . '/inc/css/twitter.css');
	}
